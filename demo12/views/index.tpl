...
<head>
    ...
    <!-- Vendor Styles -->
    <link rel="stylesheet" type="text/css" href="/public/vendors/font-awesome/css/fontawesome-all.min.css">
    <link rel="stylesheet" type="text/css" href="/public/vendors/slick-carousel/slick.css">
    <link rel="stylesheet" type="text/css" href="/public/fonts/themify-icons.css">
    <link rel="stylesheet" type="text/css" href="/public/vendors/magnific-popup/magnific-popup.css">
    <link rel="stylesheet" type="text/css" href="/public/css/hovereffects.css">
    <!-- Theme Styles -->
...
<header id="top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-white fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">car <b>plus</b></a>
    ...
    <section class="position-relative wt-section hero-large hero overflow-hidden">
        <div class="hero-img bg-overlay" data-overlay="0" style="background-image: url(/public/img/intro/banner-bg.png);"></div>
        <div class="container my-md-5 py-md-5">
            <div class="row text-white hero-content text-center my-md-4">
                <div class="col-md-5">
                    <!-- heading -->
                    <h1 class="text-uppercase mb-3 mt-5 display-4 font-weight-bolder" data-aos="fade-right" data-aos-easing="linear">
                        Car Care
                    </h1>
                    <p class="lead text-white opacity-2 h3" data-aos="fade-right" data-aos-easing="linear">
                        Best Car Wash & Detailing Service
                    </p>
    ...
    <section class="wt-section" id="services">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 mb-5 mb-lg-0 text-center" data-aos="fade-up" data-aos-easing="linear" data-aos-delay="100">
                    <div class="d-block mb-4">
                        <img src="/public/img/services/car-wash.svg" width="105px" class="pr-4" alt="">
                    </div>
                    <h4 class="h5">Car Wash</h4>
                ...
                <div class="col-lg-4 mb-5 mb-lg-0 text-center" data-aos="fade-up" data-aos-easing="linear" data-aos-delay="200">
                    <div class="d-block mb-4">
                        <img src="/public/img/services/waxing.svg" width="105px" class="pr-4" alt="">
                    </div>
                    <h4 class="h5">Waxing</h4>
                ...
                <div class="col-lg-4 mb-5 mb-lg-0 text-center" data-aos="fade-up" data-aos-easing="linear" data-aos-delay="300">
                    <div class="d-block mb-4">
                        <img src="/public/img/services/car-service1.svg" width="105px" class="pr-4" alt="">
                    </div>
                    <h4 class="h5">Denting & Painting</h4>
            ...
            <div class="row">
                <div class="col-lg-4 mb-5 mb-lg-0 text-center" data-aos="fade-up" data-aos-easing="linear" data-aos-delay="100">
                    <div class="d-block mb-4">
                        <img src="/public/img/services/car-service.svg" width="105px" class="pr-4" alt="">
                    </div>
                    <h4 class="h5">Car Service</h4>
                    <p>Easy and fast adjustments of elements are possible with WenTo UI Kit.</p>
                </div>

                <div class="col-lg-4 mb-5 mb-lg-0 text-center" data-aos="fade-up" data-aos-easing="linear" data-aos-delay="200">
                    <div class="d-block mb-4">
                        <img src="/public/img/services/files-and-folders.svg" width="105px" class="pr-4" alt="">
                    </div>
                    <h4 class="h5">Car Checkup</h4>
                    <p>Our React Powered App will save you tons of time and cost in your projects.</p>
                </div>

                <div class="col-lg-4 mb-5 mb-lg-0 text-center" data-aos="fade-up" data-aos-easing="linear" data-aos-delay="300">
                    <div class="d-block mb-4">
                        <img src="/public/img/services/brake-disc.svg" width="105px" class="pr-4" alt="">
                    </div>
                    <h4 class="h5">Wheel Alignment</h4>
    ...
    <section class="wt-section bg-light" id="about">
        <div class="container">
            ...
            <div class="row justify-content-between align-items-center" data-aos="fade-right" data-aos-easing="linear" data-aos-delay="100">
                <div class="col-md-5">
                    <img src="/public/img/about/1.jpg" width="90%" class="rounded-md" alt="">
                </div>
                <div class="col-md-7">
                    <h3 class="mb-4 ">Best Service Provider</h3>
    ...
    <section class="wt-section">
        <div class="container">
            <div class="row justify-content-between align-items-center" data-aos="fade-left" data-aos-easing="linear" data-aos-delay="100">
                ...
                <div class="col-md-5">
                    <img src="/public/img/about/2.jpg" width="90%" class="rounded-md" alt="">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="bg-white p-5 mb-4 text-center rounded-md overflow-hidden b-hover" data-aos="fade-up"  data-aos-easing="linear" data-aos-delay="300">
                        ...
                        <h6 class="my-2 text-primary">Quality</h6>
                ...
                <div class="col-md-4">
                    <div class="bg-white p-5 mb-4 text-center rounded-md overflow-hidden b-hover" data-aos="fade-up"  data-aos-easing="linear" data-aos-delay="500">
                        ...
                        <h6 class="my-2 text-primary">24/7</h6>
                        <p class="text-muted">Lorem ipsum dolor sit amet, consect adipiscing elit, sed do eiusmod</p>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="bg-white p-5 mb-4 text-center rounded-md overflow-hidden b-hover" data-aos="fade-up"  data-aos-easing="linear" data-aos-delay="800">
                        ...
                        <h6 class="my-2 text-primary">100% Guarantee</h6>
                        <p class="text-muted">Lorem ipsum dolor sit amet, consect adipiscing elit, sed do eiusmod</p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="portfolio-menu mt-2 mb-4 pb-3">
                <ul>
                    ...
                    <li class="btn mr-2" data-filter=".gts">Wash</li>
                    <li class="btn mr-2" data-filter=".lap">Painting</li>
                    <li class="btn" data-filter=".selfie">Service</li>
                </ul>
            </div>
            <div class="portfolio-item row" data-aos="fade-up" data-aos-easing="linear" data-aos-delay="100">
                <div class="item gts col-lg-3 col-md-4 col-6 col-sm">
                    <div class="hovereffect rounded-md overflow-hidden">
                        <img class="img-fluid img-responsive" src="/public/img/portfolio/img1.jpg" alt="">
                        <div class="overlay">
                            <p>
                                <a href="/public/img/portfolio/img1.jpg" class="fancylight popup-btn info" data-fancybox-group="light"><b>Detail View</b></a>
                            </p>
                        </div>
                    </div>
                ...
                <div class="item selfie col-lg-3 col-md-4 col-6 col-sm">
                    <div class="hovereffect rounded-md overflow-hidden">
                        <img class="img-fluid img-responsive" src="/public/img/portfolio/img2.jpg" alt="">
                        <div class="overlay">
                            <p>
                                <a href="/public/img/portfolio/img2.jpg" class="fancylight popup-btn info" data-fancybox-group="light"><b>Detail View</b></a>
                            </p>
                        </div>
                    </div>
                ...
                <div class="item lap col-lg-3 col-md-4 col-6 col-sm">
                    <div class="hovereffect rounded-md overflow-hidden">
                        <img class="img-fluid img-responsive" src="/public/img/portfolio/img3.jpg" alt="">
                        <div class="overlay">
                            <p>
                                <a href="/public/img/portfolio/img3.jpg" class="fancylight popup-btn info" data-fancybox-group="light"><b>Detail View</b></a>
                            </p>
                        </div>
                    </div>
                ...
                <div class="item selfie col-lg-3 col-md-4 col-6 col-sm">
                    <div class="hovereffect rounded-md overflow-hidden">
                        <img class="img-fluid img-responsive" src="/public/img/portfolio/img4.jpg" alt="">
                        <div class="overlay">
                            <p>
                                <a href="/public/img/portfolio/img4.jpg" class="fancylight popup-btn info" data-fancybox-group="light"><b>Detail View</b></a>
                            </p>
                        </div>
                    </div>
                ...
                <div class="item lap col-lg-3 col-md-4 col-6 col-sm">
                    <div class="hovereffect rounded-md overflow-hidden">
                        <img class="img-fluid img-responsive" src="/public/img/portfolio/img5.jpg" alt="">
                        <div class="overlay">
                            <p>
                                <a href="/public/img/portfolio/img5.jpg" class="fancylight popup-btn info" data-fancybox-group="light"><b>Detail View</b></a>
                            </p>
                        </div>
                    </div>
                ...
                <div class="item gts col-lg-3 col-md-4 col-6 col-sm">
                    <div class="hovereffect rounded-md overflow-hidden">
                        <img class="img-fluid img-responsive" src="/public/img/portfolio/img6.jpg" alt="">
                        <div class="overlay">
                            <p>
                                <a href="/public/img/portfolio/img6.jpg" class="fancylight popup-btn info" data-fancybox-group="light"><b>Detail View</b></a>
                            </p>
                        </div>
                    </div>
                ...
                <div class="item gts col-lg-3 col-md-4 col-6 col-sm">
                    <div class="hovereffect rounded-md overflow-hidden">
                        <img class="img-fluid img-responsive" src="/public/img/portfolio/img7.jpg" alt="">
                        <div class="overlay">
                            <p>
                                <a href="/public/img/portfolio/img7.jpg" class="fancylight popup-btn info" data-fancybox-group="light"><b>Detail View</b></a>
                            </p>
                        </div>
                    </div>
                ...
                <div class="item selfie col-lg-3 col-md-4 col-6 col-sm">
                    <div class="hovereffect rounded-md overflow-hidden">
                        <img class="img-fluid img-responsive" src="/public/img/portfolio/img8.jpg" alt="">
                        <div class="overlay">
                            <p>
                                <a href="/public/img/portfolio/img8.jpg" class="fancylight popup-btn info" data-fancybox-group="light"><b>Detail View</b></a>
                            </p>
                        </div>
                    </div>
    ...
    <div class="card bg-primary border-0 rounded-0 p-5">
        <div class="container">
            <div class="row justify-content-between align-items-center text-center text-md-left">
                <div class="col-md-8">
                    <h5 class="mb-1 d-inline-block border-right border-sm-right-0 pr-md-4 mr-md-4">HOT OFFER</h5>
                    <p class="mb-0 d-inline-block">50% off on CAR Wash.. grab the deal before end</p>
                </div>
                <div class="col-md-4 text-lg-right mt-md-0 mt-3">
                    <a href="#" class="btn btn-pill btn-outline-light">Buy Now</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6 mb-5">
                    <figure data-aos="fade-up" data-aos-easing="linear" data-aos-delay="100">
                        <img class="w-100 rounded-top" src="/public/img/team/img1.jpg" alt="Image Description">
                ...
                <div class="col-lg-3 col-sm-6 mb-5">
                    <figure data-aos="fade-up" data-aos-easing="linear" data-aos-delay="200">
                        <img class="w-100 rounded-top" src="/public/img/team/img2.jpg" alt="Image Description">
                        <div class="wt-box-shadow-sm bg-white text-center rounded p-4">
                            <div class="mb-3">
                ...
                <div class="col-lg-3 col-sm-6 mb-5">
                    <figure data-aos="fade-up" data-aos-easing="linear" data-aos-delay="300">
                        <img class="w-100 rounded-top" src="/public/img/team/img3.jpg" alt="Image Description">
                ...
                <div class="col-lg-3 col-sm-6 mb-5">
                    <figure data-aos="fade-up" data-aos-easing="linear" data-aos-delay="400">
                        <img class="w-100 rounded-top" src="/public/img/team/img4.jpg" alt="Image Description">
                        <div class="wt-box-shadow-sm bg-white text-center rounded p-4">
                            <div class="mb-3">
            ...
            <div class="row justify-content-center price-card">
                    ...
                    <div class="card text-center mb-md-0 mb-3" data-aos="fade-up" data-aos-easing="linear" data-aos-delay="200">
                        <div class="card-body py-5">
                            <div class="pricing-header mb-5">
                                ...
                                <h1>$10</h1>
                                <p class="text-muted">Car Checkup</p>
                            </div>
                            <strong>Includes:</strong>
                            <ul class="list-unstyled mt-3 price-options">
                                <li>Consectetur </li>
                                <li>Adipiscing</li>
                                <li>Lorem ipsum bems</li>
                                <li>24/7 Checkup</li>
                            </ul>
                ...
                <div class="col-md-4">
                    <div class="card text-center mb-md-0 mb-3" data-aos="fade-up" data-aos-easing="linear" data-aos-delay="300">
                        <div class="card-body py-5 bg-primary text-white">
                            <div class="pricing-header mb-5">
                            ...
                            <a href="#" class="btn btn-pill btn-light mt-3">Buy Now</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card text-center mb-md-0 mb-3" data-aos="fade-up" data-aos-easing="linear" data-aos-delay="400">
                        <div class="card-body py-5">
                            <div class="pricing-header mb-5">
                                <h5 class="font-weight-normal mb-3">Gold</h5>
                                <h1>$49</h1>
                                <p class="text-muted">All Included</p>
                            </div>
                            <strong>Includes:</strong>
                            <ul class="list-unstyled lh-45 mt-3 price-options">
                                <li>Consectetur </li>
            ...
            <div class="row">
                <div class="col-lg-6 mb-7 mb-lg-0 px-lg-5" data-aos="fade-right" data-aos-easing="linear" data-aos-delay="200">
                    ...
                    <div class="media wt-font-size-90">
                        <img class="d-flex align-self-center rounded-circle wt-blockquote-v2__image wt-box-shadow-lg mx-3 mt-2" src="/public/img/ava/img2.jpg" alt="Image description">
                ...
                <div class="col-lg-6 px-lg-5" data-aos="fade-left" data-aos-easing="linear" data-aos-delay="400">
                    ...
                    <blockquote class="wt-blockquote-v2 rounded mb-5">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration.</blockquote>
                    <div class="media wt-font-size-90">
                        <img class="d-flex align-self-center rounded-circle wt-blockquote-v2__image wt-box-shadow-lg mx-3 mt-2" src="/public/img/ava/img3.jpg" alt="Image description">
                        <div class="media-body align-self-center">
        ...
        <div class="container">
            ...
            <div class="row justify-content-md-center text-center mg-5 pb-5">
                ...
                <div class="col-md-5">
                    ...
                    <div class="row contact-info" data-aos="fade-right" data-aos-easing="linear" data-aos-delay="100">
                        <div class="col-md-12">
                            <div class="bg-white p-4 d-flex mb-md-4 border rounded-md">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 text-center text-md-left mb-3 mb-md-0">
                <small class="text-white">Copyright &copy; 2020.Company name All rights reserved.</small>
            </div>
...
<!-- JS Script Files -->
<script src="/public/vendors/jquery.min.js"></script>
<script src="/public/vendors/jquery.migrate.min.js"></script>
...
<!-- Components Vendor  -->
<script src="/public/vendors/slick-carousel/slick.min.js"></script>
<script src="/public/js/isotope.pkgd.js"></script>
<script src="/public/vendors/magnific-popup/jquery.magnific-popup.min.js"></script>
<script src="/public/vendors/counters/waypoint.min.js"></script>
<script src="/public/vendors/counters/counterup.min.js"></script>
...
<script src="/public/vendors/carousel.js"></script>
<script src="/public/vendors/counters.js"></script>
